...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::prefix('dashboard')->middleware(['auth', 'verified', 'checkSession'])->group(function () {
        ...
        Route::get('/events/{event_id}/register', [EventRegistrationController::class, 'showPrivateRegistration'])->name('events.register');
        Route::post('/events/register', [EventRegistrationController::class, 'savePrivateRegistration'])->name('events.register.post');
