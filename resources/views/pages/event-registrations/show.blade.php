                    ...
                    <div class="card-body">
                        <div class="my-2 border px-3 py-2 rounded">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <h3 class="fw-bold">{{ $event_registration->user->first_name . ' ' . $event_registration->user->last_name }}</h3>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-xl-6 col-6">
                                    ...
                                    <h5 class="fs-14 mb-0">
                                        ...
                                        <small class="text-muted" id="invoice-time">{{ Carbon::parse($event_registration->transaction->created_at)->format("H:i A") }}</small>
                                    </h5>
                                </div>
                                <!--end col-->
                                <div class="col-xl-6 col-6">
                            ...
                            <div class="py-2 px-3">
                                ...
                                <div class="row my-3 mt-3 gap-3">
                                    <div class="col-lg-5">
                                        ...
                                        <h6 class="fw-semibold">{{ $event_registration->user->first_name }} {{ $event_registration->user->last_name }}</h6>
                                    </div>
                                    <div class="col-lg-5">
                                        <h6 class="text-muted" style="line-height: 10px;">Contact Number</h6>
                                        <h6 class="fw-semibold">{{ $event_registration->user->contact_number ?? "Not Found" }}</h6>
                                    </div>
                                    <div class="col-lg-5">
                                    ...
                                    <div class="col-lg-5">
                                        ...
                                        <h6 class="fw-semibold">{{ $event_registration->user->user_details->address ?? "Not Found" }}</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
