...
@section('content')
    ...
    <div class="row my-3">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <table id="user_event_registrations_datatable" class="table nowrap align-middle table-striped"
                        style="width:100%">
                        <thead>
                            <tr>
...
@section('script')
    ...
    <script>
        $('#user_event_registrations_datatable').on('draw.dt', function() {
                    ...
                    deleteFunction: function() {
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                $('#user_event_registrations_datatable').DataTable()
                                    .draw(
                                        false);
                            },
        ...
        $('#refresh-btn').click(function () {
            $('#user_event_registrations_datatable').DataTable().draw(false);
        })
        ...
        function initializeTables() {
            ...
            let table = $("#user_event_registrations_datatable").DataTable({
                processing: true,
                pageLength: 10,
                responsive: true,
                serverSide: true,
                ajax: {
                    url: "{{ route('users.events.registrations', auth()->user()->id) }}",
                },
                columns: columns,
                language: {
